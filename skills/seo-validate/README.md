...
An upgraded, era-verified, defect-fixed derivative of [`softspark/ai-toolkit/seo-validate`](https://github.com/softspark/ai-toolkit), checked against platform reality current to 2026 (the kind of dated facts a wild skill silently predates). Conditions are stated, and every workflow step ends in a runnable check.
...
Derived from [`softspark/ai-toolkit/seo-validate`](https://github.com/softspark/ai-toolkit) · Apache-2.0 · last verified 2026-08-10. Attribution is in [SKILL.md](SKILL.md)'s Attribution section; every vendored file is pinned by sha256 in the bundle's [`bundle.json`](../../bundle.json).
